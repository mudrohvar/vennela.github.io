...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll(
        '.work-card, .article-card, .skill-card, .timeline-item, .principle'
    );
...
window.addEventListener('scroll', () => {
    ...
    if (heroBackground) {
        const shapes = heroBackground.querySelectorAll('.floating-shape');
...
console.log('%cI see you\'re checking out the code. Like what you see?', 'font-size: 14px; color: #64748B;');
console.log('%cLet\'s build something great together!', 'font-size: 14px; color: #64748B;');
